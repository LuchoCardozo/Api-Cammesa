window.addEventListener('load', () => {
    ...
    async function dataMisiones() {
        const response = await fetch('https://api.cammesa.com/demanda-svc/demanda/ObtieneDemandaYTemperaturaRegion?id_region=2426')
        const misiones = await response.json()

        misiones.forEach(element => {
