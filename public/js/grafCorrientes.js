window.addEventListener('load',()=>{
    ...
    async function dataCorrientes(){
    const response  = await  fetch('https://api.cammesa.com/demanda-svc/demanda/ObtieneDemandaYTemperaturaRegion?id_region=1893')
    const corrientes = await response.json()
    corrientes.forEach(element => {
