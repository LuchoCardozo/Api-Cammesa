window.addEventListener('load',()=>{
    ...
    async function dataFormosa(){
    const response  = await  fetch('https://api.cammesa.com/demanda-svc/demanda/ObtieneDemandaYTemperaturaRegion?id_region=1886')
    const formosa = await response.json()
  
    formosa.forEach(element => {
